                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> {{ trans('posts.discussion_id') }} </th><td> {{ $post->discussion_id }} </td></tr><tr><th> {{ trans('posts.user_id') }} </th><td> {{ $post->user_id }} </td></tr><tr><th> {{ trans('posts.body') }} </th><td> {{ $post->body }} </td></tr>
                                </tbody>
                            </table>
                        </div>
