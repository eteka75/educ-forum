...
php artisan crud:generate Categories --fields="user_id#integer;domaine_id#integer;image#file;order#integer;name#string;color#string;slug#string;description#text" --validations="name#min:3|max:500|required" --indexes="id" --foreign-keys="user_id#id#users#cascade" --localize=yes --locales=fr --model-namespace=Models --view-path=forum --controller-namespace=Forum
